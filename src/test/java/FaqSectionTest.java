...
public class FaqSectionTest extends BaseTest {
    ...
    public FaqSectionTest(String accordionHeader, String accordionText) {
    ...
    @Test
    public void checkFaqItemsText() {
        driver.get("https://qa-scooter.praktikum-services.ru/");
        QaScooterPage qaScooterPage = new QaScooterPage(driver);
        assertEquals(accordionText, qaScooterPage.getAccordionText(accordionHeader));
    }
